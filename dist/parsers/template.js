...
const parseObjectExpression = (processor, expression) => {
    if (expression.type === 'ObjectExpression') {
        expression === null || expression === void 0 ? void 0 : expression.properties.forEach((property) => {
...
const parseArrayExpression = (processor, expression) => {
    if (expression.type === 'ArrayExpression') {
        expression.elements.forEach((el) => {
            if ((el === null || el === void 0 ? void 0 : el.type) === 'LogicalExpression') {
                parseLiteralExpression(processor, el.right);
            }
            else if ((el === null || el === void 0 ? void 0 : el.type) !== 'SpreadElement') {
